...
export function Teams({ email }) {
  ...
  return (
    ...
    {userTeams.length?userTeams.map(e=>  <TeamsCard props={e}/>):null}
    </div>
    <div className={s.buttoncontainer}>
    <button className={s.button} onClick={()=>modalOpen()}>Crea un equipo</button>
    </div>
    <ModalCreateTeam email={email} showModal={showModal} setShowModal={setShowModal} />
