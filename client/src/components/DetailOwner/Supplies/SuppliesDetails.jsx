    ...
    return (
            ...
            <div className='izquierda'>
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <input type='text' className="infoForm" style={{ marginLeft: '0', fontSize: '22px', marginTop: '5px'}} name='price' onChange={ev => onClick(ev)} value={change.price} />
                    </div>
                    ...
                    <input type='text' className="infoForm" name='stock' style={{ fontSize: '22px', marginTop: '5px'}} onChange={ev => onClick(ev)} value={change.stock} />
