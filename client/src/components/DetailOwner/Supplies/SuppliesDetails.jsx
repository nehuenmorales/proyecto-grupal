    ...
    return (
            ...
            <div className='izquierda'>
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <img src='https://cdn-icons-png.flaticon.com/512/74/74742.png' className="infoForm" style={{ color: 'white', height: '25px' }}></img>
                    <input type='text' className="infoForm" style={{ marginLeft: '5px'}} name='price' onChange={ev => onClick(ev)} value={change.price} />
                    </div>
