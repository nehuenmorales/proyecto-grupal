...
export default function FutbolFields() {
  ...
  useEffect(() => {
    axios.get("/owner/getNameComplex").then((res) => {
  ...
  const validator = (field) => {
    ...
    if (!field.complexId) {
      ...
      validations.capacity =
        "Ingrese la cantidad de jugadores totales de la cancha";
          ...
          <div className="row d-flex justify-content-center align-items-center px-5">
            ...
            <div className="col-md-6 col-sm-12 px-5">
              ...
              <div>
                ...
                />
                {errors.capacity ? (
                  <div className={s.error}>{errors.capacity}</div>
                ) : null}
              </div>
